...
/**
 * Servlet implementation class GetBDQALtiActivity
 * @author cskamil
 */
@WebServlet("/GetDBQALtiActivity")
public class GetDBQALtiActivity extends HttpServlet {
	private static final long serialVersionUID = 1L;
	
	public GetDBQALtiActivity() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, String[]> codelab_activity = this.getUserDBQALtiActivity(contentInput.getUserId(), contentInput.getGroudId(), contentInput.getDateFrom());
	...
	public HashMap<String, String[]> getUserDBQALtiActivity(String usr, String domain, String dateFrom) {
		ConfigManager cm = new ConfigManager(this);
		um2DBInterface um2_db = new um2DBInterface(cm.um2_dbstring,cm.um2_dbuser,cm.um2_dbpass);
		
		um2_db.openConnection();
		HashMap<String, String[]> dbqaLTIActivityMap= um2_db.getUserDBQALtiActivity(usr, dateFrom);
		um2_db.closeConnection();
		
		return dbqaLTIActivityMap;
	}
}
